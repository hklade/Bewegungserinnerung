...
- [x] 3.1 Run a full manual pass of the `android-quick-entry` capability spec against a physical or emulated device, checking every scenario listed in the spec file — not verifiable in this devcontainer (no emulator/device)
